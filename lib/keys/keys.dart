...
import 'package:flutter_and_dart_course/keys/checkable_todo_item.dart';

import 'package:flutter_and_dart_course/keys/todo_item.dart' hide Priority;
          ...
          child: Column(
            children: [
              ...
              for (final todo in _orderedTodos)
                CheckableTodoItem(
                  key: ValueKey(todo.text), // The ValueKey is the lightweight way of ObjectKey(todo)
                  todo.text,
                  todo.priority,
                ),
            ],
