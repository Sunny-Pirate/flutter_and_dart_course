{ pkgs, ... }: {
  ...
  idx = {
    ...
    workspace = {
      ...
      onCreate = {
        build-flutter = ''
          cd /home/user/flutter_and_dart_course/android

          ./gradlew \
            --parallel \
            -Pverbose=true \
            -Ptarget-platform=android-x86_64 \
            -Ptarget=/home/user/flutter_and_dart_course/lib/main.dart \
            -Pbase-application-name=solutions.dreamlab.fluttercourse.Application \
